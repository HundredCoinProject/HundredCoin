...
const string strMessageMagic = "Hundredcoin Signed Message:\n";
...
{
    // Hundredcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetSpacing = 100; // Hundredcoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Hundredcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Hundredcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Hundredcoin comes into existence";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c6d3a4e55b240fa4c71772c7546d12271ecab0cfebbe9e6a30a8f73c75fafd80f448fc723e0b3e8ec91ea6847221f803632617c62824acf34c90ee004ad91cbb83") << OP_CHECKSIG;
        CBlock block;
        ...
        //assert(block.hashMerkleRoot == uint256("0x17f9b43d4ddc68b644bb3d173dda434218d4098a2061f5b7a61c93cc28f00af8"));
        assert(block.hashMerkleRoot == uint256("0x6c1c4ed4abb2ff7bf79e84c9bf9aaa3e77de69b0fef086929a0c2bca00a3d223"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Hundredcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HundredcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HundredcoinMiner : ProcessBlock, block not accepted");
    }
